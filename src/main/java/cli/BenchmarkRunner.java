...
public class BenchmarkRunner {
    ...
    private static final int[] DEFAULT_SIZES = {100, 1_000, 10_000, 100_000};
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (CSVWriter writer = new CSVWriter(path, "distributive", "size", "time_ms", "comparisons", "accesses")) {
            for (int size : sizes) {
                for (String dist : distributions) {
                    ...
                    System.out.printf("dist=%s, size=%d, %s%n", dist, size, tracker);
                }
            }
        }
